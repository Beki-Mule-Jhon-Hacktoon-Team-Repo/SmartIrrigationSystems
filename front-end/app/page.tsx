          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground text-balance">
                Optimize water usage, increase crop yield, and reduce costs with
                intelligent irrigation management powered by AI and real-time
                sensor data.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Everything you need to manage your irrigation efficiently and
              sustainably.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description:
                  "Reduce water consumption by up to 40% and increase crop yield with optimized irrigation.",
              },
              {
                icon: <Award className="w-8 h-8" />,
                title: "Weather Integration",
                description:
                  "Automatic weather forecasting to adjust irrigation schedules and prevent water waste.",
              },
              {
                icon: <Users className="w-8 h-8" />,
                title: "Multi-Farm Management",
                description:
                  "Manage multiple farms from a single dashboard with role-based access control.",
              },
              {
                icon: <Droplets className="w-8 h-8" />,
                title: "Predictive Analytics",
                description:
                  "AI-powered predictions help you make informed decisions for crop planning.",
              },
            ].map((feature, i) => (
      ...
      <section id="impact" className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              See how SmartAgriSense is transforming agriculture across the
              globe.
            </p>
          </div>
      ...
      <section className="bg-primary text-primary-foreground py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg opacity-90 mb-8 max-w-2xl mx-auto">
            Join hundreds of farmers already using SmartAgriSense to grow
            better.
          </p>
          <Link href="/register">
